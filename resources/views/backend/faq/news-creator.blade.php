    ...
    <div class="col-md-9">
        <div class="widget">
            <header class="widget-header">
                <h4 class="widget-title text-center">Faq Yazısı Oluştur</h4>
            </header><!-- .widget-header -->
            <hr class="widget-separator">
            <div class="widget-body">

                <form method="post" action="{{route('admin.faq.kaydet')}}" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                ...
                <div class="form-group">
                    ...
                    <select id="treatmentkategori" type="treatmentkategori" class="form-control" name="blogkategori">
                        <option value="">--Kategori Seçiniz--</option>
                        @foreach ($treatmentkategori as $bk)
            ...
            <div class="widget-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::date('created_at', \Carbon\Carbon::now()->format('D/M/Y'), ['class' => 'form-control', 'required' => true]) !!}

                        <label class="col-md-6 label-control" for="userinput5">Guncellenme zamanı :</label>
                        {!! Form::date('updated_at', \Carbon\Carbon::now()->format('D/M/Y'), ['class' => 'form-control', 'required' => true]) !!}
                    </div>
