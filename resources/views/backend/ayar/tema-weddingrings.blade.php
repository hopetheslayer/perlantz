    ...
    <div class="col-md-12">
        <div class="widget">
            <header class="widget-header">
                <h3 class="text-center">About Wedding Rings Sayfa Ayarları</h3>
            </header><!-- .widget-header -->

            <div class="widget-body">


                <form method="POST" class="form-horizontal" action="{{route('admin.weddingrings.kaydet')}}" enctype="multipart/form-data">

                    @csrf
                    <hr style="margin-top: 10px;" class="widget-separator">
                    @foreach($wedding as $a)
                        <div class="col-12">
