...
<div class="topbar">
    ...
    {{-- Search --}}
    @if (config('xdlayout.extras.search.display'))
        ...
        @else
            <div class="dropdown" id="kt_quick_search_toggle">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    @include('xdlayout.partials.extras.dropdown._search-dropdown')
                </div>
            </div>
        @endif
    @endif
    ...
    {{-- Notifications --}}
    @if (config('xdlayout.extras.notifications.display'))
        ...
        @else
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        @include('xdlayout.partials.extras.dropdown._notifications')
                    </form>
                </div>
            </div>
        @endif
    ...
    {{-- Quick Actions --}}
    @if (config('xdlayout.extras.quick-actions.display'))
        ...
        @else
            <div class="dropdown">
                ...
                {{-- Dropdown --}}
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    @include('xdlayout.partials.extras.dropdown._quick-actions')
                </div>
            </div>
        @endif
    @endif
    ...
    {{-- My Cart --}}
    @if (config('xdlayout.extras.cart.display'))
        <div class="dropdown">
            {{-- Toggle --}}
            <div class="topbar-item"  data-toggle="dropdown" data-offset="10px,0px">
                <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                <form>
                    @include('xdlayout.partials.extras.dropdown._cart')
                </form>
            </div>
        </div>
    @endif
    ...
    {{-- Quick panel --}}
    @if (config('xdlayout.header.topbar.quick-panel.display'))
        <div class="topbar-item">
    ...
    {{-- Languages --}}
    @if (config('xdlayout.extras.languages.display'))
        <div class="dropdown">
            <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                @include('xdlayout.partials.extras.dropdown._languages')
            </div>
        </div>
    @endif

    {{-- User --}}
    @if (config('xdlayout.extras.user.display'))
        ...
        @else
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    @include('xdlayout.partials.extras.dropdown._user')
                </div>
            </div>
        @endif
    @endif
