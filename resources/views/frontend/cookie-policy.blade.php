                    ...
                    <div class="breadcrumb-wrap">
                        ...
                        <nav aria-label="breadcrumb">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" href="{{route('cookie')}}" aria-current="page">Cookie Policy</li>
    ...
    <div style="margin-top: 25px;" class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12">
                ...
                <iframe src="frontend/documents/cookie-policy.pdf#toolbar=0" width="100%" height="600px"></iframe >
