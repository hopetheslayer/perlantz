                    ...
                    <div class="breadcrumb-wrap">
                        ...
                        <nav aria-label="breadcrumb">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" href="{{route('privacy')}}" aria-current="page">Privacy Policy</li>
    ...
    <div style="margin-top: 25px;" class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12">
                ...
                <iframe src="frontend/documents/return-warranty.pdf#toolbar=0" width="100%" height="600px"></iframe >
