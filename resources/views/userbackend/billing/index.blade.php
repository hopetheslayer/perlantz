                    ...
                    <div class="breadcrumb-wrap">
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="{{route('user.billing')}}">Billing Address</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="account-details-form">
                        <form method="post" action="{{ route('user.billing.kaydet',$userdetay->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="single-input-item">
                                        ...
                                        {!! Form::text('firm_name',$userdetay->firm_name, ['class' => 'form-control  form-control bg-light-5 border-0 rounded ' ,'placeholder' => 'Firm Name', 'required' => '']) !!}
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="single-input-item">
                                        <label class="required">Country </label>
                                        {!! Form::text('state',$userdetay->country, ['class' => 'form-control  form-control bg-light-5 border-0 rounded ' ,'placeholder' => 'State', 'required' => '']) !!}
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="single-input-item">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="single-input-item">
                                        ...
                                        {!! Form::text('tax_no',$userdetay->taxno, ['class' => 'form-control  form-control bg-light-5 border-0 rounded' ,'placeholder' => 'Tax no', 'required' => '']) !!}
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="single-input-item">
                                        <label class="required">Zip Code</label>
                                        {!! Form::text('zipcode',$userdetay->zipcode, ['class' => 'form-control  form-control bg-light-5 border-0 rounded ' ,'placeholder' => 'Zipcode', 'required' => '']) !!}
                                    </div>
                                </div>
                            ...
                            <div style="margin-top: 25px; margin-bottom: 25px;">
                                <button style="" type="submit" class="btn btn-sqr">
                                    <span>SAVE CHANGES</span>
                                    <i class="icon-long-arrow-right"></i>
                                </button>
                                <a href="{{route('user.address')}}" style="color:#fff3cd;" class="btn btn-sqr">Back</a>
                            </div>
